...
describe("[Challenge] Backdoor", function () {
  ...
  it("Execution", async function () {
    ...
    //get balances of registry and user
    let logBalances = async (address, name) => {
      ...
      console.log(`Wallet balance of ${name} is: `, balance);
      console.log(`The token balance of ${name} is: `, tokenBalance);
      console.log("");
    };
